  ...
  return (
   <section id='home' className={`flex md:flex-row flex-col ${styles.paddingY} hero-top`}>
      <div className={`flex-1 ${styles.flexStart} flex-col xl:px-0 sm:px-16 px-6 mobile`}>
        <div className='flex flex-row items-center py-[6px] px-4 hero bg-discount-gradient rounded-[10px] mb-2'>
      ...
      <div className={`flex-1 flex ${styles.flexCenter} md:my-10 my-10 image-dev relative`}>
        <img src={rob} alt='billing' className='w-[100%]  relative z-[5] floating-image'/>
